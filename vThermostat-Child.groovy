definition(
    ...
    namespace: "Derakkon",
    author: "Josh McAllisster & Derakkon",
...
preferences {
	...
	section("Initial Thermostat Settings: "){
		input "heatingSetPoint", "decimal", title: "Heating Setpoint", required: true, defaultValue: 20.0
		input "coolingSetPoint", "decimal", title: "Cooling Setpoint", required: true, defaultValue: 24.4
...
def installed()
{
    ...
    try {
        thermostat = addChildDevice("Derakkon", "vThermostat Device", state.deviceID, null, [label: label, name: label, completedSetup: true])
    } catch(e) {
